...
public final class HasznaltautoHuProvider extends AbstractService implements MakeModelProvider {
    ...
    public String getMakes() {
        ...
        HasznaltautoHuReader hasznaltautoHuReader = JsonParser.jsonToObject(rawJson, HasznaltautoHuReader.class);
        Collection<HasznaltautoHuReader.MakeValues> markakSzemelyautoFilter = hasznaltautoHuReader.getMarkakSzemelyautoFilter();
    ...
    public String getModelsByMake(String makeId) {
        ...
        HasznaltautoHuModelsReader hasznaltautoHuModelsReader = JsonParser.jsonToObject(rawJson, HasznaltautoHuModelsReader.class);
        Collection<HasznaltautoHuModelsReader.ModelValues> modellekSzemelyautoFilter = hasznaltautoHuModelsReader.getModellekSzemelyautoFilter();
