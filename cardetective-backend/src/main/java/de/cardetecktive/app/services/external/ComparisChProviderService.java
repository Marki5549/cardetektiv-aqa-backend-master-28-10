...
@Service
public class ComparisChProviderService extends AbstractService implements MakeModelProvider {
    ...
    public ComparisChProviderService(Supplier<RequestSpecification> requestSpecification) {
