...
import de.cardetecktive.app.services.SocketAuthenticationService;
import de.cardetecktive.app.utils.JsonFormatter;
import de.cardetecktive.app.utils.JsonParser;
import de.cardetecktive.app.utils.WsMessageUtils;
...
import static de.cardetecktive.app.constants.enums.WebSocketMessageCode.*;
...
public final class WebSocketSteps extends AbstractBackendSteps {
    ...
    public void authorizeToTheWebSocket(final Cookie cdSid) {
        if(isAuth) {
            return;
        }
